...
class MoreCodingProjects extends React.Component {
  ...
  render() {
    return (
      ...
      >
        <h2>More coding projects</h2>
        <button className="previous-button more-code-projects-button">
          <img src={previousArrow} alt="Previous item button" />
        </button>
        <button className="next-button more-code-projects-button">
...
export default MoreCodingProjects;
