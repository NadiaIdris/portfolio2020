      ...
      <div className="project-page-column-component-container">
        ...
        <div className="bullet-point-container space-between-paragraphs">
          ...
          <p>
            ...
            JS event delegation, JS events (keyboard events, mouse events, form
        ...
        <div className="bullet-point-container space-between-paragraphs">
          ...
          <p>
            <span>ES6:&nbsp;</span>
            template literals, arrow functions, classes, modules, spread syntax,
        ...
        <div className="bullet-point-container space-between-paragraphs">
          ...
          <p>
            <span>CSS:&nbsp;</span>
            CSS grid and CSS Flexbox for page layouts, CSS variables, CSS and JS
